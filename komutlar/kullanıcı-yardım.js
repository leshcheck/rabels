...
.setDescription(client.commands.filter(cmd => cmd.conf.kategori === 'kullanıcı').map(cmd => `
...
exports.conf = {
  enabled: true,
  aliases: ['kullanıcı-system', 'kullanici-sistem', 'yardım-kullanıcı', 'kullanıcı-yardım'],
  permLevel: 0,
};
